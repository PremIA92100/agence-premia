  ...
  useEffect(() => {
    ...
    const draw = () => {
      ...
      for (const node of nodes) {
        ...
        ctx.fillStyle = `rgba(0, 212, 255, ${pulseOpacity * 0.1})`;
        ctx.fill();
...
export function Hero() {
  return (
    <section className="relative min-h-screen flex flex-col justify-center overflow-hidden">
      ...
      <div className="absolute bottom-0 left-0 w-[400px] h-[400px] rounded-full bg-[radial-gradient(circle,rgba(245,158,11,0.05)_0%,transparent_70%)]" />
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8 relative z-10 py-32 lg:py-40">
        <div className="max-w-4xl">
          ...
          <motion.div
            ...
            className="mb-10"
          >
            <span className="inline-flex items-center gap-2 rounded-full border border-[var(--color-border)] bg-[var(--color-bg-elevated)] px-4 py-2 text-xs font-bold uppercase tracking-[0.2em] text-[var(--color-cyan)] backdrop-blur-sm">
          ...
          >
            ...
            <br />
            <span className="text-[var(--color-text-muted)]">qui fait tourner</span>
            <br />
          ...
          <motion.p
            ...
            className="mt-8 text-lg lg:text-xl text-[var(--color-text-muted)] leading-relaxed max-w-xl"
          >
          ...
          >
            <a
              href="#contact"
              className="group inline-flex items-center gap-3 rounded-full bg-[var(--color-cyan)] px-8 py-4 text-base font-bold text-[var(--color-bg)] shadow-[0_0_30px_rgba(0,212,255,0.3)] hover:shadow-[0_0_50px_rgba(0,212,255,0.5)] hover:scale-105 active:scale-100 transition-all duration-300"
            >
              Lancer mon projet
            ...
            <a
              href="#services"
              className="inline-flex items-center gap-2 rounded-full border border-[var(--color-border)] bg-white/[0.03] px-7 py-4 text-base font-semibold text-[var(--color-text-muted)] backdrop-blur-sm hover:text-white hover:border-[var(--color-border-hover)] hover:bg-white/[0.06] transition-all duration-300"
            >
      ...
      >
        <div className="mx-auto max-w-7xl px-6 lg:px-8 py-8">
          <div className="flex flex-col sm:flex-row items-center gap-8 sm:gap-16">
            <p className="text-xs font-bold uppercase tracking-[0.2em] text-[var(--color-text-dim)] whitespace-nowrap">
            ...
            <div className="flex flex-wrap items-center justify-center gap-10 sm:gap-14">
              {clients.map((client, i) => (
                ...
                >
                  <div className="text-sm font-bold text-[var(--color-text-dim)] group-hover:text-[var(--color-cyan)] transition-colors duration-300">
                    {client.name}
                  </div>
                  <div className="text-[10px] text-[var(--color-text-dim)]/50 mt-0.5">
                    {client.type}
                  </div>
                </motion.div>
              ))}
